...
// r8 = scount0
    ...
    mov  rdi,rdx          // edi <- dest
    mov  ebx,r8d          // ebx <- scount0
    mov  ecx,dword ptr dcount     // ecx <- dcount
...
//  if dcount = 0 then Exit;
    ...
    push rsi
    mov  rsi,rax          // esi <- source

//  doffset := dcount0 - doffset * scount0 mod dcount0 - 1;
    mov  eax,dword ptr [doffset]
    xor  edx,edx
    imul eax,ebx
    idiv eax,dword ptr dcount0
    mov  eax,dword ptr dcount0
    stc
    sbb  eax,edx
